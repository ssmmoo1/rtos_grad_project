...
int main(void){ 
  ...
  EnableInterrupts();  
	...
	char str1[] = "test dev 0";
	char str2[] = "test dev 1";
	
	
	ST7735_Message(0, 0, str1, 1, 1);
	ST7735_Message(1, 0, str2, 1, 1);
	
	ST7735_Message(0, 1, str1, 1, 0);
	ST7735_Message(1, 1, str2, 1, 0);
	
	ST7735_Message(0, 2, str1, -1, 1);
	ST7735_Message(1, 2, str2, -10, 1);
	
	ST7735_Message(0, 3, str1, -20, 0);
	ST7735_Message(1, 3, str2, -20, 1);
	
	ST7735_Message(0, 4, str1, 1, 0);
	ST7735_Message(1, 4, str2, 1, 0);
	
	ST7735_Message(0, 5, str1, 1, 0);
	ST7735_Message(1, 5, str2, 1, 0);
	
	ST7735_Message(0, 6, str1, 1, 0);
	ST7735_Message(1, 6, str2, 1, 0);
